...
import handleClickScroll from "../components/molecules/HelpCard/HelpCard";
          ...
          <section className={style.HelpCard_answer}>
            ...
            <div className={style.ans}>
              ...
              <IonText className={style.answer}>
                Daftar akun OnExam semakin mudah dengan cara daftar menggunakan
                Email.
              </IonText>
              ...
              <IonText className={style.answer}>
                Berikut beberapa langkah mudah untuk bisa login ke akun OnExam.
              </IonText>
            ...
            <div className={style.ans}>
              ...
              <IonText className={style.answer}>
                Tidak menemukan Exam yang dicari dapat disebabkan beberapa alasan, yaitu Exam belum dibuat atau kendala lainnya.
              </IonText>
            </div>
